...
class ConsultaodontologicaexpressSearch extends Persona
{
    ...
    public function rules()
    {
        return [
            ...
            [['Nombres', 'Apellidos', 'FechaNacimiento', 'Direccion', 'Correo', 'IdGeografia', 'Genero', 'IdParentesco', 'Telefono', 'Celular', 'Alergias', 'Medicamentos', 'Enfermedad', 'Dui', 'TelefonoResponsable', 'Categoria', 'NombresResponsable', 'ApellidosResponsable', 'Parentesco', 'DuiResponsable', 'RutaCarpeta', 'UltimaVisita', 'ProximaVisita'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere([
            ...
            'ProximaVisita' => $this->ProximaVisita,
        ]);
