...
/**
 * ExpedienteodontologicoSearch represents the model behind the search form of `app\models\Persona`.
 */
class ExpedienteodontologicoSearch extends Persona
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['IdPersona', 'IdEstadoCivil', 'IdEstado', 'IdPais', 'CodigoPaciente'], 'integer'],
            [['Nombres', 'Apellidos', 'FechaNacimiento', 'Direccion', 'Correo', 'IdGeografia', 'Genero', 'IdParentesco', 'Telefono', 'Celular', 'Alergias', 'Medicamentos', 'Enfermedad', 'Dui', 'TelefonoResponsable', 'Categoria', 'NombresResponsable', 'ApellidosResponsable', 'Parentesco', 'DuiResponsable', 'RutaCarpeta'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'Nombres', $this->Nombres])
            ...
            ->andFilterWhere(['like', 'RutaCarpeta', $this->RutaCarpeta]);
