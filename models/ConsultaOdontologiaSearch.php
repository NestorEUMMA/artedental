...
/**
 * ConsultaOdontologiaSearch represents the model behind the search form of `app\models\Consulta`.
 */
class ConsultaOdontologiaSearch extends Consulta
{
    /**
     * {@inheritdoc}
     */
    public function rules()
    {
        return [
            ...
            [['Diagnostico', 'Comentarios', 'Otros', 'FechaConsulta', 'EstadoNutricional', 'CirugiasPrevias', 'MedicamentosActuales', 'ExamenFisica', 'PlanTratamiento', 'FechaProxVisita', 'Alergias', 'Consultaimaurl', 'IPServer', 'UnidadServer'], 'safe'],
        ];
    }
