...
<script type="text/javascript">
   ...
   $.post( "../../views/expedienteodontologico/historicoesp.php", { IdFactor: "4",
               IdPersona: "<?php echo $idpersonaid; ?>"})
         .done(function( data ) {
            $("#gestacion").html(data);
         });
      
         $.post( "../../views/expedienteodontologico/historicoesp.php", { IdFactor: "5",
               IdPersona: "<?php echo $idpersonaid; ?>"})
         .done(function( data ) {
            $("#nacimiento").html(data);
         });
      
         $.post( "../../views/expedienteodontologico/historicoesp.php", { IdFactor: "6",
               IdPersona: "<?php echo $idpersonaid; ?>"})
         .done(function( data ) {
            $("#infancia").html(data);
         });
      
         $.post( "../../views/expedienteodontologico/historicoesp.php", { IdFactor: "7",
               IdPersona: "<?php echo $idpersonaid; ?>"})
         .done(function( data ) {
            $("#amamantamiento").html(data);
         });
      
         $.post( "../../views/expedienteodontologico/historicoesp.php", { IdFactor: "8",
               IdPersona: "<?php echo $idpersonaid; ?>"})
         .done(function( data ) {
            $("#alimentacion").html(data);
         });
      
         $.post( "../../views/expedienteodontologico/historicoesp.php", { IdFactor: "9",
               IdPersona: "<?php echo $idpersonaid; ?>"})
         .done(function( data ) {
            $("#endulzantes").html(data);
         });
      
         $.post( "../../views/expedienteodontologico/historicoesp.php", { IdFactor: "10",
               IdPersona: "<?php echo $idpersonaid; ?>"})
         .done(function( data ) {
            $("#alimentacionnocturna").html(data);
         });
      
         $.post( "../../views/expedienteodontologico/historicoesp.php", { IdFactor: "11",
               IdPersona: "<?php echo $idpersonaid; ?>"})
         .done(function( data ) {
            $("#higienenocturna").html(data);
         });

         $.post( "../../views/expedienteodontologico/historicoesp.php", { IdFactor: "12",
               IdPersona: "<?php echo $idpersonaid; ?>"})
         .done(function( data ) {
            $("#primeravisita").html(data);
         });
