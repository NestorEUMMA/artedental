<script type="text/javascript">
   $(document).ready(function() {
      ...
      $(".btn-cargarconsulta").click(function() {
         ...
         //alert(id);
         $.ajax({
            url: "../../views/consultaodontologicaexpress/cargarconsulta.php",
            type: "POST",
            data: myData,
            dataType: "JSON",
            beforeSend: function() {
            ...
            success: function(data) {
               $("#cargarusuario").val(data.usuario);
               $("#cargarpaciente").val(data.paciente);
               $("#cargarfecha").val(data.fechaconsulta);
               $("#cargarmodulo").val(data.modulo);
