   ...
   <div class="modal-dialog modal-lg">
      <div class="modal-content animated fadeIn">
         <div class="modal-header">
            ...
            <small id=''>PACIENTE:</small><small> <?php echo $nombres; echo " "; echo $apellidos; ?> </small>
         </div>
...
<div class="modal inmodal" id="modalCargarDiente" tabindex="-1" role="dialog" aria-hidden="true">
   <div class="modal-dialog modal-md">
      <div class="modal-content animated fadeIn">
         ...
         <div class="modal-body">
            <form class="form-horizontal" method="POST" action="../../views/consultaodontologicaexpress/actualizarortogramadetalle.php" id="demo-form" data-parsley-validate="">
               <div class="form-group">
                  <div class="hidden">
                     IDPERSONA
...
<div class="modal inmodal" id="modalGuardarPlantratamiento" tabindex="-1" role="dialog" aria-hidden="true">
   <div class="modal-dialog modal-lg">
      <div class="modal-content animated fadeIn">
         ...
         <form class="form-horizontal" method="POST" action="../../views/consultaodontologicaexpress/guardarplantratamiento.php" id="demo-form" data-parsley-validate="">
            <div class="modal-body">
               <div class="hidden">
                  IDPERSONA
                  <textarea type="text" rows="4" class="form-control" name="txtpersonaID"> <?php echo $idpersonaid ?> </textarea>
...
<div class="modal inmodal" id="modalEliminarHistoricoPlanTratamiento" tabindex="-1" role="dialog" aria-hidden="true">
   <div class="modal-dialog modal-sm">
      <div class="modal-content animated fadeIn">
         ...
         <form class="form-horizontal" method="POST" action="../../views/consultaodontologicaexpress/eliminarplantratamiento.php" id="demo-form" data-parsley-validate="">
            <div class="modal-body">
               <div class="hidden">
               <div class="hidden">
                     IDPERSONA
...
<div class="modal inmodal" id="modalGuardarDiagnostico" tabindex="-1" role="dialog" aria-hidden="true">
   <div class="modal-dialog modal-lg">
      <div class="modal-content animated fadeIn">
         ...
         <form class="form-horizontal" method="POST" action="../../views/consultaodontologicaexpress/actualizarconsulta.php" id="demo-form" data-parsley-validate="">
            <div class="modal-body">
               <div class="form-group">
                  <div class="col-sm-2"><label for="inputEmail3" class="control-label" id=''>Fecha</label>
                  </div>
                  <div class="col-sm-10"><input value="<?php echo $date ?>" class="form-control" name="txtFecha"
                     disabled="disabled"></div>
                  <div class="col-sm-1"></div>
               </div>
               <div class="form-group">
                  <div class="col-sm-2"><label for="inputEmail3" class="control-label" id=''>Doctora</label>
                  </div>
                  <div class="col-sm-10">
               ...
               <div class="form-group">
                  <div class="col-sm-2"><label for="inputEmail3" class="control-label"
                     id=''>Paciente</label></div>
                  <div class="col-sm-10"><input type="text" value="<?php echo $nombres. " " .$apellidos ?>"
                     class="form-control" disabled="disabled">
                     <input type="hidden" name="txtPaciente" value="<?php echo $idpersona ?>">
                  </div>
               </div>
               <div class="form-group">
                  <div class="col-sm-2"><label for="inputEmail3" class="control-label" id=''>Modulo</label>
                  </div>
                  <div class="col-sm-10">
            ...
            <div class="modal-body">
               <div class="form-group">
                  ...
                  <div class="col-sm-10">
                     <div class="input-group">
                        <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                        <textarea type="text" id="cargarfecha" disabled="disabled" rows="1" class="form-control" name="" required=""> </textarea>
                     </div>
                  </div>
               </div>
               <div class="form-group">
                  ...
                  <div class="col-sm-10">
                     <div class="input-group">
                        <div class="input-group-addon"><i class="fa fa-user"></i></div>
                        <textarea type="text" id="cargarusuario" disabled="disabled" rows="1" class="form-control" name="" required=""> </textarea>
                     </div>
                  </div>
               </div>
               <div class="form-group">
                  <div class="col-sm-2"><label for="inputEmail3" class="control-label" id=''>Paciente</label></div>
                     <div class="col-sm-10">
                     <div class="input-group">
                        <div class="input-group-addon"><i class="fa fa-user"></i></div>
                        <textarea type="text" id="cargarpaciente" disabled="disabled" rows="1" class="form-control" name="" required=""> </textarea>
                     </div>
                  </div>
               </div>
               <div class="form-group">
                  ...
                  <div class="col-sm-10">
                     <div class="input-group">
                        ...
                        <textarea type="text" id="cargarmodulo" disabled="disabled" rows="1" class="form-control" name="" required=""> </textarea>
                     </div>
                  </div>
               </div>
               <div class="form-group">
