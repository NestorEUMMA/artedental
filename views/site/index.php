...
<script>
    $(function() {
            ...
            <?php if ($_SESSION['IdIdioma'] == 1){ ?>
                    toastr.success('ArteDental 4 Kids', 'Bienvenido');
              <?php }else
                { ?>
                     toastr.success('ArteDental 4 Kids', 'Welcome');
                <?php } ?>
 });
...
$(document).ready(function() {
   ...
   <?php if ($_SESSION['IdIdioma'] == 1){ ?>
       $("#encabezado1").text('Adminstración de Pacientes y Control Dental');
...
<?php }else
  { ?>
       $("#encabezado1").text('Patient Management');
