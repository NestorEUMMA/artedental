   ...
   <?php 
        ...
        $fechaInicio = $_POST['txtInicio1'];
        $fechaFinal = $_POST['txtFinal1'];
        ...
        $queryfecha = "SELECT C.IdConsulta, P.IdPersona, UPPER(CONCAT(P.Nombres,' ',P.Apellidos)) AS 'Nombre', C.FechaProxVisita, P.Celular FROM consulta C
        INNER JOIN persona P ON P.IdPersona = C.IdPersona
        WHERE C.FechaProxVisita BETWEEN'$fechaInicioFormat'  and '$fechaFinalFormat'
        GROUP BY P.IdPersona, C.FechaProxVisita = (SELECT MAX(FechaProxVisita) FROM consulta)
        UNION ALL
        SELECT C.IdConsulta, P.IdPersona, UPPER(CONCAT(P.Nombres,' ',P.Apellidos)) AS 'Nombre', C.FechaProxVisita, P.Celular FROM consulta C
        INNER JOIN persona P ON P.IdPersona = C.IdPersona
        WHERE C.FechaProxVisita like '%-$mesinicio-$anioinicio%'
        GROUP BY P.IdPersona, C.FechaProxVisita = (SELECT MAX(FechaProxVisita) FROM consulta)";
      ...
      <div class="wrapper wrapper-content">
         <div class="ibox-content">
            <div class="row">
               ...
               <div class="col-xs-5">
                  <h2>LISTADO DE PROXIMAS CONSULTAS DE  <?php echo $numMes ?> DE <?php echo $anioinicio ?> </h2>
                  <small>
                     <address>
               ...
               <div class="row">
               <div class="col-xs-12">
                <h4>REPORTE DE PROXIMAS CONSULTAS DEL <?php echo $fechaInicio ?> AL <?php echo $fechaFinal ?></h4>
               <table id="example2" cellspacing="0" cellpadding="0" class="table table-striped">
                    ...
                    echo "<th id=''>PROXIMA CONSULTA</th>";
                    ...
                    $nr = 0;
                        while ($row = $resultadoFecha->fetch_assoc()) {
                            ...
                            echo "<td>" . $row['FechaProxVisita'] . "</td>";
