...
use app\models\ConsultaOdontologiaSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * ConsultaodontologiaController implements the CRUD actions for Consulta model.
 */
class ConsultaodontologiaController extends Controller
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $searchModel = new ConsultaOdontologiaSearch();
